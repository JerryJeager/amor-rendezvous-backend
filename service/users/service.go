...
type UserSv interface {
	...
	CreateToken(ctx context.Context, user *service.User) (string, string, error)
}
...
func (o *UserServ) CreateToken(ctx context.Context, user *service.User) (string, string, error) {
